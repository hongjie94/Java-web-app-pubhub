			...
			<tbody>
				<c:forEach var="tag" items="${tags}">
					<tr>
						...
						<td> 
						  <form method="post" action="RemoveBookTag" style=" display: flex; justify-content: flex-end;">
							  <input type="hidden" value="${tag.isbn13}" name="isbn13"/>
							  <input type="hidden" value="${tag.tagName}" name="tagName"/>
	...
	<section class="success">
	  <div class="container">
		...
		<form action="AddBookTag" method="post" class="form-horizontal">
		  ...
		  <div class="form-group">
		    <label for="tag" class="col-sm-4 control-label">Tag Name</label>
		    
		    <div class="col-sm-5">
		      <input type="text" class="form-control" id="tag" name="tagName" placeholder="Tag Name" required="required" />
		    </div>
		  </div>
		  <div class="form-group">
